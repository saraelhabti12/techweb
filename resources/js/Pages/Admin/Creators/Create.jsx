    ...
    return (
        <AdminLayout auth={auth}>
            ...
            <DashboardPage 
                ...
                description="Enter talent details and upload portfolio images."
                actions={
                        ...
                        <div className="lg:col-span-1 space-y-8">
                            <DashboardCard title="Profile Photo">
                                <div className="space-y-4">
                                    ...
                                    {errors.profile_photo && <p className="text-xs text-red-500 font-bold">{errors.profile_photo}</p>}
                                </div>
                            </DashboardCard>
                        ...
                        <div className="lg:col-span-2 space-y-8">
                                ...
                                <div className="space-y-6">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <textarea 
                                            ...
                                            placeholder="Modeling, Acting, Dancing..."
                                        />
                                    </div>
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <textarea 
                                            ...
                                            className="w-full bg-gray-50 dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-xl p-3 text-sm dark:text-white outline-none focus:ring-2 focus:ring-[#1F2BF3] h-24 resize-none"
                                            placeholder="Previous work, brands, etc..."
                                        />
                                    </div>
                                </div>
                            </DashboardCard>
                            ...
                            <DashboardCard title="Gallery Portfolio">
                                <div className="space-y-6">
                                    ...
                                    {errors.gallery_images && <p className="text-xs text-red-500 font-bold">{errors.gallery_images}</p>}
                                </div>
                            </DashboardCard>
                            ...
                            <div className="flex justify-end pt-8">
                                ...
                                >
                                    {processing ? 'Saving...' : 'Create Creator'}
                                </DashboardButton>
                            </div>
                        </div>
                    </div>
