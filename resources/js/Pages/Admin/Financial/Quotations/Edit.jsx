...
import { 
    ...
    Calendar, User, FileText, Hash, Percent, 
    DollarSign, ArrowRight, Send
} from 'lucide-react';
...
export default function Edit({ auth, quotation, clients }) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        put(route('admin.quotations.update', quotation.id));
    };
    ...
    return (
        <AdminLayout auth={auth}>
            ...
            <DashboardPage
                ...
                description="Update the quotation details or change its status."
                                    ...
                                    <div className="space-y-3 pt-4">
                                        ...
                                        {data.status === 'accepted' && (
                                            <DashboardButton
                                                type="button"
                                                variant="secondary"
                                                className="w-full justify-center border-blue-500 text-blue-600 hover:bg-blue-50"
                                                onClick={() => router.post(route('admin.quotations.convert-to-invoice', quotation.id))}
                                            >
